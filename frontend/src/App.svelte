  ...
  >
    ...
    >
      ...
      <header class="mb-8 flex justify-between items-end z-10 shrink-0">
        <div>
          <h1 class="text-2xl text-white font-bold mb-1">Asset Workspace</h1>
      ...
      >
        ...
        >
          ...
          <span class="text-emerald-100 font-medium">Approved Image</span>
        </div>
        ...
        <div class="bg-white/5 p-4 rounded-sm border border-white/5">
          ...
          <ul class="text-sm text-gray-300 space-y-2">
            <li class="flex justify-between">
              <span>Age:</span> <span class="text-white">25 - 45</span>
            </li>
            <li class="flex justify-between">
              <span>Location:</span> <span class="text-white">DACH</span>
            </li>
          </ul>
        </div>
      </div>
